...
figma.ui.onmessage = (msg) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        if (msg.type === 'create') {
            ...
            const strokeColor = strokeColors[noteType] || { r: 0, g: 0, b: 0 }; // fallback
            // note frame
            ...
            yield figma.loadFontAsync({ family: "DM Sans", style: "Bold" });
            ...
            yield figma.loadFontAsync({ family: "DM Sans", style: "Medium" });
            ...
            yield figma.loadFontAsync({ family: "DM Sans", style: "Regular" });
